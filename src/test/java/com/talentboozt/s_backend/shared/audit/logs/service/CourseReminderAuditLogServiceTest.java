package com.talentboozt.s_backend.shared.audit.logs.service;

import com.talentboozt.s_backend.shared.audit.logs.model.CourseReminderAuditLog;
import com.talentboozt.s_backend.shared.audit.logs.repository.mongodb.CourseReminderAuditLogRepository;
...
class CourseReminderAuditLogServiceTest {
    ...
    void logAuditSavesLogWithValidData() {
        // Setup input data
        EmpCoursesModel emp = new EmpCoursesModel("1", "emp123", "John Doe", "john.doe@example.com", "0123456789",
                "Asia/Colombo", null, null);
        CourseEnrollment course = new CourseEnrollment("course123", "Java Basics", "batch123", null, null, null,
                "2023-10-01T10:00:00Z", "enrolled", null, null, null);
        ModuleDTO module = new ModuleDTO("module123", "Introduction", null, null, null, "2023-10-01", "04:30", "06:00",
                "2023-10-01T10:00:00Z", "2023-10-01T11:30:00Z", "Asia/Colombo", null, null, null, false);
        ...
        verify(auditLogRepo).save(argThat(savedLog -> savedLog.getCourseId().equals("course123") &&
    ...
    void logAuditHandlesInvalidTimezoneGracefully() {
        ...
        verify(auditLogRepo).save(argThat(log -> log.getScheduledStartTime().equals("Invalid timezone or time") &&
    ...
    void logAuditHandlesInvalidUtcStartGracefully() {
        EmpCoursesModel emp = new EmpCoursesModel("1", "emp123", "John Doe", "john.doe@example.com", "0123456789",
                "Asia/Colombo", null, null);
        CourseEnrollment course = new CourseEnrollment("course123", "Java Basics", "batch123", null, null, null, null,
                null, null, null, null);
        ModuleDTO module = new ModuleDTO("module123", "Introduction", null, null, null, null, null, null, "InvalidDate",
    ...
    void logAuditSetsExpirationTimeCorrectly() {
        ...
        CourseEnrollment course = new CourseEnrollment("course123", "Java Basics", "batch123", null, null, null, null,
                null, null, null, null);
        ModuleDTO module = new ModuleDTO("module123", "Introduction", null, null, null, null, null, null,
                "2023-10-01T10:00:00Z", null, null, null, null, null, false);

        courseReminderAuditLogService.logAudit(emp, course, module, 60, "SENT", "Reminder sent successfully");

        verify(auditLogRepo).save(argThat(log -> log.getExpiresAt().isAfter(Instant.now()) &&
