package com.talentboozt.s_backend.shared.audit.logs.controller;

import com.talentboozt.s_backend.shared.audit.logs.controller.StripeAuditLogController;
import com.talentboozt.s_backend.shared.audit.logs.model.StripeAuditLog;
import com.talentboozt.s_backend.shared.audit.logs.repository.mongodb.StripeAuditLogRepository;
...
class StripeAuditLogControllerTest {
    ...
    void getLogsForRetryReturnsLogsWithRetryPendingStatus() {
        List<StripeAuditLog> logs = List.of(new StripeAuditLog(), new StripeAuditLog());
        when(stripeAuditLogRepository.findTop20ByStatusAndRetryCountLessThanOrderByCreatedAtAsc("retry_pending", 3))
                .thenReturn(logs);
