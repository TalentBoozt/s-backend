...
import com.talentboozt.s_backend.domains.portal.content.article.dto.ArticleEvaluationDTO;
...
import com.talentboozt.s_backend.domains.portal.content.article.repository.mongodb.ArticleEvaluationLogRepository;
import com.talentboozt.s_backend.domains.portal.content.article.repository.mongodb.ArticleRepository;
    ...
    public void validateArticle(Article article) {
        ...
        if ("APPROVED".equals(publishStatus)) {
            ...
            eventPublisher.publishEvent(
                    new com.talentboozt.s_backend.domains.portal.content.article.event.ArticlePublishedEvent(this, article));
