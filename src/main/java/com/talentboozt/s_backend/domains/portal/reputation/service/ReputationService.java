...
public class ReputationService {
    ...
    public List<com.talentboozt.s_backend.domains.portal.reputation.dto.LeaderboardEntry> getLeaderboard(int limit) {
        ...
        return typedTuples.stream()
                .map(tuple -> {
                    ...
                    return com.talentboozt.s_backend.domains.portal.reputation.dto.LeaderboardEntry.builder()
                            .userId(userId)
