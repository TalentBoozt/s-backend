...
public class FinFinanceExceptionHandler {
    ...
    @ExceptionHandler(com.talentboozt.s_backend.domains.finance.exception.FinValidationException.class)
    public org.springframework.http.ResponseEntity<java.util.Map<String, Object>> handleValidation(
            com.talentboozt.s_backend.domains.finance.exception.FinValidationException ex) {
