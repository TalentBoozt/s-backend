...
import com.talentboozt.s_backend.domains.finance.analytics.models.AnalyticsData;
import com.talentboozt.s_backend.domains.finance.analytics.repository.AnalyticsRepository;
...
public class AnalyticsPrecomputationService {
    ...
    private final com.talentboozt.s_backend.domains.finance.repository.mongodb.FinSalesPlanRepository salesPlanRepository;
    ...
    public void precomputeAll(String organizationId, String projectId, String scenarioId) {
        ...
        List<com.talentboozt.s_backend.domains.finance.models.FinSalesPlan> salesPlans = salesPlanRepository.findByOrganizationIdAndProjectId(organizationId, projectId);
        ...
        for (int i = 0; i < snapshots.size(); i++) {
            ...
            // Cost per User
            Optional<com.talentboozt.s_backend.domains.finance.models.FinSalesPlan> plan = salesPlans.stream()
