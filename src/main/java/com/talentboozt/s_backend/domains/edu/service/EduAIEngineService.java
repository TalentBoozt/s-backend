...
public class EduAIEngineService {
    ...
    private final com.talentboozt.s_backend.shared.subscription.service.SubscriptionFeatureFlagService featureFlagService;
    private final EduAnalyticsEventService analyticsEventService;

    public EduAIEngineService(EduAICreditService creditService, LLMRouter llmRouter, EduAccessGuardService accessGuard, com.talentboozt.s_backend.shared.subscription.service.SubscriptionFeatureFlagService featureFlagService, EduAnalyticsEventService analyticsEventService) {
