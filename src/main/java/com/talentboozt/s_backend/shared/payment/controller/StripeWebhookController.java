package com.talentboozt.s_backend.shared.payment.controller;

import com.stripe.exception.SignatureVerificationException;
import com.stripe.param.CustomerUpdateParams;
import com.talentboozt.s_backend.shared.payment.service.*;
...
public class StripeWebhookController {
    ...
    @Autowired private com.talentboozt.s_backend.shared.subscription.service.SubscriptionService userSubscriptionService;
    ...
    private void handleSubscriptionPurchase(Event event, Session session) throws StripeException {
        ...
        if (userId != null) {
            // User subscription
            try {
                com.talentboozt.s_backend.shared.subscription.domain.model.SubscriptionPlanCode plan =
                        com.talentboozt.s_backend.shared.subscription.domain.model.SubscriptionPlanCode
